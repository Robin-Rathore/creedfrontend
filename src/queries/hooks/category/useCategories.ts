...
export const useCategories = (params?: CategoriesQuery) => {
  return useQuery({
    ...
    queryFn: (): Promise<{ success: boolean; count: number; data: Category[] }> => apiClient.get("/categories", params),
...
export const useCategoryTree = () => {
  return useQuery({
    ...
    queryFn: (): Promise<{ success: boolean; data: Category[] }> => apiClient.get("/categories/tree"),
    select: (data) => data.data,
...
export const useCategory = (id: string) => {
  return useQuery({
    ...
    queryFn: (): Promise<{ success: boolean; data: Category }> => apiClient.get(`/categories/${id}`),
    select: (data) => data.data,
    enabled: !!id,
  })
}
...
export const useCategoryBySlug = (slug: string) => {
  return useQuery({
    ...
    queryFn: (): Promise<{ success: boolean; data: Category }> => apiClient.get(`/categories/slug/${slug}`),
    select: (data) => data.data,
    enabled: !!slug,
  })
}
